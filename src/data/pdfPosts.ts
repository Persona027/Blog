...
export const pdfPosts: PdfPostMeta[] = [
  ...
  },
  {
    ...
    title: '软件工程基础 第7章 — 详细设计 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第7章详细设计完整学习笔记，涵盖图形描述工具、Jackson和Warnier结构化设计方法、面向对象设计原则，共39页课件全部内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch7-detailed-design.pdf',
  },
  {
    slug: 'se-ch8-testing',
    title: '软件工程基础 第8章 — 软件测试 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第8章软件测试，涵盖测试策略、白盒测试、黑盒测试、单元测试、集成测试、测试用例设计等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch8-testing.pdf',
  },
  {
    slug: 'se-ch3-management',
    title: '软件工程基础 第3章 — 软件项目管理 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第3章软件项目管理，涵盖项目估算、进度管理、风险管理、质量管理、配置管理等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch3-management.pdf',
  },
  {
    slug: 'se-ch4-planning',
    title: '软件工程基础 第4章 — 软件项目计划 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第4章软件项目计划，涵盖项目估算方法（COCOMO、功能点、代码行）、进度计划、风险管理计划等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch4-planning.pdf',
  },
  {
    slug: 'se-ch2-process',
    title: '软件工程基础 第2章 — 软件过程 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第2章软件过程，涵盖软件过程模型、敏捷开发、RUP等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch2-process.pdf',
  },
  {
    slug: 'se-ch5-requirements',
    title: '软件工程基础 第5章 — 软件需求分析 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第5章软件需求分析，涵盖需求获取、结构化分析、面向对象分析、数据流图、数据字典等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch5-requirements.pdf',
  },
  {
    slug: 'se-preface',
    title: '软件工程基础 — 前言与课程导论 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础课程前言与导论，涵盖课程目标、教学内容、学习方法、考核方式等',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-preface.pdf',
  },
  {
    slug: 'se-ch6-highlevel-design',
    title: '软件工程基础 第6章 — 概要设计 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第6章概要设计，涵盖结构化设计方法、模块化设计、内聚与耦合、面向对象概要设计、类图等核心内容',
    cover: 'D:/Git/logo.png',
    pdfUrl: '/pdfs/se-ch6-highlevel-design.pdf',
  },
  {
    slug: 'se-ch1-overview',
    title: '软件工程基础 第1章 — 软件工程概述 详细学习笔记',
    date: '2026-05-28',
    category: '软件工程基础',
    summary: '软件工程基础第1章软件工程概述，涵盖软件危机、软件工程定义、软件生命周期、软件开发模型等核心概念',
    cover: 'D:/Git/logo.png',
