...
const About = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto pt-10 px-6 pb-20">
            <div className="bg-black/40 backdrop-blur-md rounded-2xl p-10 border border-white/10 text-center mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {hobbies.map((hobby) => (
                    <Link 
                        ...
                        className="group bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-6 flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-1"
                    >
